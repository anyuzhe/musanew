...
class EmailHelper
{
    static function emailToUserCode($user, $code)
    {
        global $CFG;
        ...
        $data->link = $CFG->wwwroot . '/login/forgot_password.php?token=' . $code;
...
//        $subject = get_string('emailresetconfirmationsubject', '', format_string($site->fullname));
        ...
        return self::emailTo($user, $supportuser, $subject, $message);
    }

    static function emailTo($user, $from, $subject, $messagetext, $messagehtml = '', $attachment = '', $attachname = '',
